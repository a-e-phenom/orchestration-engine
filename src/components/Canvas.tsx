        ...
        <div className="fixed right-0 top-[65px] h-[calc(100%-64px)] w-[502px] bg-white border-l border-gray-200 shadow-lg z-50 overflow-y-auto">
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 border-gray-100 text-gray-700 rounded-lg font-medium transition-colors">
